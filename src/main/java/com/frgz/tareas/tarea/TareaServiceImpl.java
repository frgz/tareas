...
class TareaServiceImpl implements TareaService {
	...
	/* (non-Javadoc)
	 * @see com.frgz.tareas.tarea.TareaService#setTareaRepository(com.frgz.tareas.tarea.TareaRepository)
	 */
	@Override
	@Autowired
	...
	public List<Tarea> visualizar(String nombre) {
		return this.tareaRepository.findByNombre(nombre);
	}	

	/* (non-Javadoc)
	 * @see com.frgz.tareas.tarea.TareaService#guardar(com.frgz.tareas.tarea.Tarea)
	 */
	@Override
